...
Defines how the Game Service observes and surfaces events broadcast by the DragnCards room channel to HTTP and MCP clients. Covers alert buffering, bad-game-state detection, state-unavailable error handling, and GUI update observation.
