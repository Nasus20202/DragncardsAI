<!-- Scope: content contract for the player-facing Marvel Champions skill shipped at
     skills/marvel-champions-play/. Skill discovery, load_skill, and load_skill_reference
     mechanics live in agent-orchestrator/spec.md and llm-capabilities/spec.md. -->
