...
describe("SwaggerWorkspace", () => {
    ...
    vi.stubGlobal(
      ...
      vi.fn().mockResolvedValue({
        ...
        json: async () => ({
          ...
          errors: [{ service: "game", message: "offline" }],
        }),
      })
    );
  ...
  it("shows a fetch error", async () => {
    ...
    await waitFor(() =>
      expect(
        screen.getByText("Failed to load merged OpenAPI: 503")
      ).toBeInTheDocument()
    );
  });
});
