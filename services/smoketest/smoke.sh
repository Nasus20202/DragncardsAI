...
# Default to single-slot init for CI stability; tune up only if/when multi-slot startup is proven stable.
...
export DEFAULT_REASONING_ENABLED="${DEFAULT_REASONING_ENABLED:-false}"
